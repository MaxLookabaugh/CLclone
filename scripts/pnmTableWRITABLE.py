...
#make list of tuples to track mac address error rate?
# would just need to add a call 

'''
myMac = ['0008B918E345', 'hello', "E0CA94857967"]#'FC25E3003E4D']
myCounts = ['0','0','0']
macZipped= zip(myMac,myCounts)

for x in macZipped:
	print(x)
mac_dict = dict(macZipped)
for x in mac_dict:
	print(x)

def addErrorCount(MAC, errorList):
...
addErrorCount('E0CA948570967',macZipped)
'''
			...
			for list in my_dict[t]:
				...
				for x in (list):	
					...
					if (count%3 == 1 and count%6 != 1):
						...
						if (current_val == "docsPnmCmDsOfdmRxMerMean" and (x < 200 and x > 0)):
							print(current_val,"is ", x)
						elif (current_val == "docsPnmCmDsOfdmRxMerThrVal" and (x < 200 and x > 0)):
							print(current_val,"is ", x)
